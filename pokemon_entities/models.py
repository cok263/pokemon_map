...
class Pokemon(models.Model):
    ...
    title_jp = models.CharField('Японское название', max_length=200, default='', blank=True)
    title_en = models.CharField('Английское название', max_length=200, default='', blank=True)
